...
$(document).ready(function(){
	...
	function SaveImg(n){
		if(n < response.length){
			...
			if( response[n]['Home Address 1'].length == 0 || response[n]['Home City'].length == 0 || response[n]['Home State'].length == 0 || response[n]['Home Zip'].length == 0 ){
				
				homeAddress = $('#workcity').val() + ' ' + $('#workstate').val();
			}
			else{
				
				homeAddress = response[n]['Home Address 1'] + ' ' + response[n]['Home City'] + ' ' + response[n]['Home State'] + ' ' + response[n]['Home Zip'];
			}
